...
CIV_COLORS = {
    'United States':           {'city': [255, 255, 255], 'territory': [ 31,  51, 120]},
    ...
    'Prussia':           {'city': [ 36,  43,  32], 'territory': [179, 177, 184]},
    ...
    'Portugal':          {'city': [255, 255, 255], 'territory': [  3,  20, 124]},
    'Sardinia':              {'city': [239, 198,   0], 'territory': [ 70,   0, 118]},
    'Russia':            {'city': [  0,   0,   0], 'territory': [211, 159, 0]},
    'Siam':              {'city': [176,   7,   3], 'territory': [245, 230,  55]},
    'Songhai':           {'city': [ 90,   0,   9], 'territory': [213, 145,  19]},
    'Spain':             {'city': [244, 168, 168], 'territory': [255, 223, 0]},
    ...
    'Netherlands':   {'city': [255, 255, 255], 'territory': [255, 143,   0]},
    'Ottomans':      {'city': [ 18,  82,  30], 'territory': [0, 88, 56]},
